...
// // Fetch Name Of User (STILL NEED TO DO)
fetch("/name", {
  method: "GET"
  ...
  return response.text();
    ...
    let output = document.createTextNode(name);
    let namePlaceholder = document.getElementById("username")
    namePlaceholder.appendChild(output);
